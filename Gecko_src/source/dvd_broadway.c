...
//---------------------------------------------------------------------------------
s32 DVDLowStopLaser(dvdcallbacklow cb)
//---------------------------------------------------------------------------------
{
	s32 ret;
	struct dicontext *ctx;
...
//---------------------------------------------------------------------------------
s32 DVD_EnableVideo(dvdcallbacklow cb)
//---------------------------------------------------------------------------------
{
	s32 ret;
	struct dicontext *ctx;
...
//--------------------------------------------------------------------------------- 
s32 DVD_LowOffset(u64 offset,dvdcallbacklow cb)
//---------------------------------------------------------------------------------
{
	s32 ret;
...
//--------------------------------------------------------------------------------- 
s32 DVD_LowPrepareCoverRegister(dvdcallbacklow cb)
//---------------------------------------------------------------------------------
{
	s32 ret;
	struct dicontext *ctx;
...
//--------------------------------------------------------------------------------- 
s32 DVDLowStopMotor(u8 stop1,u8 stop2,dvdcallbacklow cb)
//---------------------------------------------------------------------------------
{
	s32 ret;
	struct dicontext *ctx;
...
//--------------------------------------------------------------------------------- 
s32 DVDLowRequestError(dvdcallbacklow cb)
//---------------------------------------------------------------------------------
{
	s32 ret;
	struct dicontext *ctx;
